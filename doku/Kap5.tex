...
\begin{description}
    \item[feedparser-Kompatibilität:] \texttt{feedparser} liefert je nach
        Feed-Format (RSS~1.0, RSS~2.0, Atom) unterschiedliche Feldnamen für
        denselben Inhalt. Beschreibungen stehen mal unter \texttt{summary}, mal
        unter \texttt{description}, mal unter \texttt{content}. Ebenso variieren
        die Datumsfelder. Das erfordert eine sorgfältige Normalisierung in der
        Parse-Schicht -- was ich anfangs unterschätzt habe.
    ...
    \item[Word-Boundary-Matching:] Einfaches String-Matching führt bei kurzen
        ...
        Falsch-Positiven. Regex mit \texttt{\textbackslash b} löst das Problem,
        ist aber auch denkbar langsamer als \texttt{str.find()} -- bei der
        aktuellen Artikelanzahl spielt das allerdings keine Rolle.
\end{description}
